...
\usepackage[top=0.3in, left=0.4in, right=0.4in, bottom=0.9in]{geometry}
...
\begin{document}
  ...
  \begin{itemize}[leftmargin=51mm, noitemsep, topsep=0pt]
    ...
    \item \en{Expected Graduation Date: May 2015}\ignorespaces
          \de{Erwartetes Abschlussdatum: Mai 2015}
  \end{itemize}
  ...
  \cventry{\en{Jun 2015 - current}\de{Jun 2015 - heute}}{Unister Travel GmbH.}
          {\en{Backend web software and automation for flight portals in PHP}
           \ignorespaces
           \de{Backend Websofware und Automation f\"ur Flugportale auf PHP}}{}{}
          {}
  ...
  \cventry{\en{Oct 2014 - current}\de{Okt 2014 - heute}}{3DMeshFileKit}
          {\en{Haskell library for reading various file formats containing 3D
               polygon mesh}\ignorespaces
           \de{Haskell-Softwarebibliothek, die verschiedene Dateiformate liest,
               die 3D-Polygonnetz beinhalten}}{}{}{}
  \cventry{\en{Nov 2013 - current}\de{Nov 2013 - heute}}{Thugaim}
          {\en{2D video game for Android in Java}\ignorespaces
           \de{2D-Videospiel f\"ur Android in Java}}{}{}{}
  \cventry{\en{Aug 2011 - current}\de{Aug 2011 - heute}}{KKSystem}
