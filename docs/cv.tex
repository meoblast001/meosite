...
\begin{document}
  ...
  \begin{itemize}[leftmargin=51mm, rightmargin=10mm, noitemsep, topsep=0pt]
    \item Maintenance of user-facing Qt/Windows application for controlling and programming theatre machinery.
    \item Development of TypeScript/Rust application for reporting and analysing data from manufacturing systems.
    \item Development and maintenance of application for controlling, programming, and reporting for automated manufacturing systems.
  \end{itemize}
  ...
  \cventry{Nov 2019}
          ...
          {\en{2D platformer game made in Godot}\ignorespaces
           \de{2D-Plattformspiel, das in Godot gemacht wurde}}{}{}
          {\url{https://github.com/meoblast001/3m5GameJamNovember2019}}
  \cventry{\en{May 2019}\de{Mai 2019}}
          {Island Escape (3m5 GameJam May 2019)}
          {\en{3D network multiplayer (2-player) action game made in Unity3D}\ignorespaces
           \de{3D-Netzwerkmultiplayer (2-Spieler) Actionspiel, das in Unity3D gemacht wurde}}{}{}
