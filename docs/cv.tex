...
\begin{document}
  ...
  \cventry{\en{Aug 2015 - current}\de{Aug 2015 - heute}}{Hakyll SASS}
          {\en{Compiler for Hakyll which uses libsass to compile SASS files to
               CSS}\ignorespaces
           \de{\"Ubersetzer f\"ur Hakyll, der libsass verwendet, um SASS-Dateien
               zu CSS-Dateien zu \"ubersetzen}}{}{}{}
